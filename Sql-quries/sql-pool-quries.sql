...
-- CREATING A SCOPE 
-- we are creating a database scoped credential to access the ADLS Gen2 storage account using Managed Identity
--creating a scope to get access to the storage account
